...
package Rectangle.Object_Test_Data is

   type Object_Access is access all GNATtest_Generated.GNATtest_Standard.Rectangle.Object'Class;
...
end Rectangle.Object_Test_Data;
